...
urlpatterns = [
    ...
    path('staff/', include('staffboard.urls')),
...
# For feedback and Notification
    ...
    path('send_all_staff_notification', HodViews.send_all_staff_notification, name="send_all_staff_notification"),
